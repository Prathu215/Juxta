...
public class AutoMobile {
	...
	@Id
	@GeneratedValue //This annotation is responsible to generate automated ids in database.x
	private int autoId;
	...
	public String toString() {   
		return "AutoMobile [autoId=" + autoId + ", autoBrand=" + autoBrand + ", autoSeries=" + autoSeries
