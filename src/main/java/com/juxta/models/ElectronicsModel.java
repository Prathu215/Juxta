...
public class ElectronicsModel {
	...
	public String toString() {
		return "ElectronicsModel [deviceId=" + deviceId + ", deviceBrand=" + deviceBrand + ", deviceModel="
				+ deviceModel + ", deviceSeries=" + deviceSeries + ", deviceType=" + deviceType + ", deviceRAM="
				+ deviceRAM + ", deviceHDD=" + deviceHDD + ", devicePrice=" + devicePrice + ", deviceProcessor="
				+ deviceProcessor + ", deviceScreenSize=" + deviceScreenSize + ", deviceBatteryPower="
				+ deviceBatteryPower + ", deviceUSBSlots=" + deviceUSBSlots + ", deviceHDMI=" + deviceHDMI + "]";
	}
